...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "playgame.py"
 
        #Name of program
        self.project_name = "GreekMythologyTrivia"
 
        #Project url
        self.project_url = "https://github.com/cmoresid/greek-myth-trivia"
 
        #Version of program
        self.project_version = "0.9.0"
 
        #License of the program
        self.license = "MIT License"
 
        #Auhor of program
        self.author_name = "Connor Moreside"
        self.author_email = "cmoresid@ualberta.ca"
        self.copyright = "Copyright (c) 2013 Connor Moreside"
 
        #Description
        self.project_description = "A simple Greek mythology trivia game."
        ...
        self.extra_scripts = ['game','eztext','menu','observer','questions','screens','TextWidget']
    ...
    def run(self):
        ...
        extra_datas = ['font/adonais.ttf','img/bg_img.jpg','img/correct.png','img/incorrect.png','music/bg_music.mp3','music/correct.ogg','music/incorrect.ogg','links.txt','data/questions.json']
